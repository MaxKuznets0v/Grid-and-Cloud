...
base_path = '/GridandClound/Requester/v1'

definitions = {'definitions': {'Request': {'type': 'object', 'properties': {'email': {'type': 'string'}, 'password': {'type': 'string'}, 'doc': {'type': 'string'}}, 'xml': {'name': 'Request'}}, 'Register': {'type': 'object', 'properties': {'email': {'type': 'string'}, 'password': {'type': 'string'}}, 'xml': {'name': 'Register'}}, 'Document_signed': {'type': 'object', 'properties': {'doc': {'type': 'string'}, 'sign': {'type': 'string'}}, 'xml': {'name': 'Document_signed'}}}, 'parameters': {}}

validators = {
    ('request', 'POST'): {'json': {'$ref': '#/definitions/Request'}},
    ('register', 'POST'): {'json': {'$ref': '#/definitions/Register'}},
}

filters = {
    ('request', 'POST'): {404: {'headers': None, 'schema': None}, 200: {'headers': None, 'schema': {'$ref': '#/definitions/Document_signed'}}},
    ('register', 'POST'): {400: {'headers': None, 'schema': None}, 201: {'headers': None, 'schema': None}},
}
