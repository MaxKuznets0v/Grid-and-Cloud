...
base_path = '/GridandClound/Signer/v1'

definitions = {'definitions': {'User': {'type': 'object', 'properties': {'email': {'type': 'string'}, 'password': {'type': 'string'}}, 'xml': {'name': 'User'}}, 'Document': {'type': 'object', 'properties': {'doc': {'type': 'string'}}, 'xml': {'name': 'Document'}}, 'Document_signed': {'type': 'object', 'properties': {'doc': {'type': 'string'}, 'sign': {'type': 'string'}}, 'xml': {'name': 'Document_signed'}}}, 'parameters': {}}

validators = {
    ('user', 'POST'): {'json': {'$ref': '#/definitions/User'}},
    ('document', 'POST'): {'json': {'$ref': '#/definitions/Document'}},
}

filters = {
    ('user', 'POST'): {400: {'headers': None, 'schema': None}, 200: {'headers': None, 'schema': None}},
    ('document', 'POST'): {404: {'headers': None, 'schema': None}, 200: {'headers': None, 'schema': {'$ref': '#/definitions/Document_signed'}}},
}
